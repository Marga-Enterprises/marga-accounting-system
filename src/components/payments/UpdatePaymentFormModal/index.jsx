      ...
      <Box sx={styles.modalWrapper}>
        ...
        <Box component="form" onSubmit={onSubmit} sx={styles.form}>
          <TextField
            ...
            value={
              formValues.payment_date
                ? new Date(formValues.payment_date).toISOString().split("T")[0]
                : ""
            }
          ...
          <TextField
            ...
            type="date"
            value={
              formValues.payment_posting_date
                ? new Date(formValues.payment_posting_date).toISOString().split("T")[0]
                : ""
            }
            onChange={onFormChange}
            fullWidth
          ...
          <TextField
            ...
            type="date"
            value={
              formValues.payment_collection_date
                ? new Date(formValues.payment_collection_date).toISOString().split("T")[0]
                : ""
            } 
            onChange={onFormChange}
            fullWidth
...
export default React.memo(UpdatePaymentFormModal);
